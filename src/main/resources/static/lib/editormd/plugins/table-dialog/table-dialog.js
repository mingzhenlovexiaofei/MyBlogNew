	...
	var factory = function (exports) {
		...
		exports.fn.tableDialog = function() {
			...
			var dialogContent = [
				...
				dialogLang.rows + " <input com.wmz.blog.type=\"number\" value=\"3\" class=\"number-input\" style=\"width:40px;\" max=\"100\" min=\"2\" data-rows />&nbsp;&nbsp;",
				dialogLang.cols + " <input com.wmz.blog.type=\"number\" value=\"2\" class=\"number-input\" style=\"width:40px;\" max=\"100\" min=\"1\" data-cols /><br/>",
			...
			if (faBtns.html() === "")
			{
				...
				for (var i = 0, len = icons.length; i < len; i++) 
				{
					...
					btn += "<input com.wmz.blog.type=\"radio\" name=\"table-align\" id=\"editormd-table-dialog-radio"+i+"\" value=\"" + values[i] + "\"" +checked + " />&nbsp;";
