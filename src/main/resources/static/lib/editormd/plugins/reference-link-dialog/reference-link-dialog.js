		...
		exports.fn.referenceLinkDialog = function() {
            ...
            {      
                var dialogHTML = "<div class=\"" + classPrefix + "form\">" +
                                        ...
                                        "<input com.wmz.blog.type=\"text\" value=\"[" + ReLinkId + "]\" data-name />" +  
                                        "<br/>" +
                                        "<label>" + dialogLang.urlId + "</label>" +
                                        "<input com.wmz.blog.type=\"text\" data-url-id />" +
                                        "<br/>" +
                                        "<label>" + dialogLang.url + "</label>" +
                                        "<input com.wmz.blog.type=\"text\" value=\"http://\" data-url />" + 
                                        "<br/>" +
                                        "<label>" + dialogLang.urlTitle + "</label>" +
                                        "<input com.wmz.blog.type=\"text\" value=\"" + selection + "\" data-title />" +
                                        "<br/>" +
                                    "</div>";
