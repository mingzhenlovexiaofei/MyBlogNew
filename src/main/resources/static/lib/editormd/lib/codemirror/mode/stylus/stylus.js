    ...
    var tokenBase = function(stream, state) {
      ...
      if (stream.match(/[\w-]*/i)) {
        ...
        if(cssProperties[word] !== undefined) {
          ...
          // CSS com.wmz.blog.type selectors
          indent(state);
          return "tag";
